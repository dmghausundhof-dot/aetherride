...
export const COMPATIBILITY_RULES: CompatibilityRuleDef[] = [
  ...
  {
    code: "RL-BRK-009F",
    title: "Vordere Scheibe vs. Gabel-Maximum",
    severity: "safety_critical",
    slotA: "rotor_front",
    slotB: "fork",
    requiresA: ["rotor_diameter_mm"],
    requiresB: ["max_rotor_mm"],
    predicate: "rotor_within_max",
    onPass: "COMPATIBLE",
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Vordere Scheibe {a.rotor_diameter_mm} mm überschreitet Gabel-Maximum {b.max_rotor_mm} mm.",
    howToObtain: {
      rotor_diameter_mm: "Scheiben-Aufdruck / Katalog",
      max_rotor_mm: "Gabel-Handbuch",
    },
    sourceUrl: "https://www.ridefox.com/",
    reviewedBy: "AetherRide Editorial",
    reviewedAt: "2026-08-06",
  ...
  {
    code: "RL-FRM-005",
    title: "Hinterachse Rahmen vs. Nabe",
    severity: "safety_critical",
    slotA: "frame",
    slotB: "rear_hub",
    requiresA: ["axle_rear"],
    ...
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Rahmen-Hinterachse {a.axle_rear} ≠ Nabe {b.axle_rear}.",
    howToObtain: {
      axle_rear: "Rahmen-/Naben-Spec (12×148 Boost, 12×142, …)",
    },
    sourceUrl: "https://www.bikeradar.com/advice/buyers-guides/mtb-axle-standards",
    reviewedBy: "AetherRide Editorial",
    reviewedAt: "2026-08-06",
  ...
  {
    code: "RL-HS-001",
    title: "Steuersatz oben vs. Rahmen",
    severity: "safety_critical",
    slotA: "headset",
    slotB: "frame",
    requiresA: ["headset_top"],
    requiresB: ["headset_top"],
    predicate: "equals",
    onPass: "COMPATIBLE",
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Steuersatz oben {a.headset_top} passt nicht zum Rahmen {b.headset_top} (S.H.I.S.).",
    howToObtain: {
      headset_top: "S.H.I.S. Rahmen-/Steuersatz-Spec (ZS44, IS42, …)",
    },
    sourceUrl:
      "https://www.mountainflyermagazine.com/img/upimages/standardized_headset_identification_system.pdf",
    reviewedBy: "AetherRide Editorial",
  ...
  {
    code: "RL-HS-001B",
    title: "Steuersatz unten vs. Rahmen",
    severity: "safety_critical",
    slotA: "headset",
    slotB: "frame",
    requiresA: ["headset_bottom"],
    requiresB: ["headset_bottom"],
    predicate: "equals",
    onPass: "COMPATIBLE",
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Steuersatz unten {a.headset_bottom} passt nicht zum Rahmen {b.headset_bottom} (S.H.I.S.).",
    howToObtain: {
      headset_bottom: "S.H.I.S. Rahmen-/Steuersatz-Spec (ZS56, IS52, …)",
    },
    sourceUrl:
      "https://www.mountainflyermagazine.com/img/upimages/standardized_headset_identification_system.pdf",
    reviewedBy: "AetherRide Editorial",
  ...
  },
  {
    ...
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Akku {a.motor_interface} passt nicht zum Motor {b.motor_interface}. Kein Fremdtausch außerhalb OEM.",
    howToObtain: {
      motor_interface: "OEM Motor-/Akku-System (z. B. bosch_smart_system)",
    },
    sourceUrl: "https://www.bosch-ebike.com/",
    reviewedBy: "AetherRide Editorial",
    reviewedAt: "2026-08-06",
  ...
  {
    code: "RL-WHL-011",
    title: "Hinterreifen-Laufradgröße vs. Felge",
    severity: "safety_critical",
    slotA: "tire_rear",
    slotB: "rear_rim",
    requiresA: ["wheel_size"],
    ...
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Hinterreifen {a.wheel_size} passt nicht zur Felge {b.wheel_size}.",
    howToObtain: {
      wheel_size: "ETRTO / Felgen-Datenblatt (29, 27.5, 700c)",
    },
