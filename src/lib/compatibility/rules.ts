...
export const COMPATIBILITY_RULES: CompatibilityRuleDef[] = [
  ...
  {
    code: "RL-WHL-012",
    title: "Vorderrad-Felgengröße vs. Gabel",
    severity: "safety_critical",
    slotA: "front_rim",
    slotB: "fork",
    requiresA: ["wheel_size"],
    ...
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Felge {a.wheel_size} passt nicht zur Gabelfreigabe {b.wheel_size}.",
    howToObtain: {
      wheel_size: "Felgen- / Gabel-Datenblatt (29, 27.5)",
    },
  ...
  {
    code: "RL-WHL-013",
    title: "Hinterrad-Felgengröße vs. Rahmen",
    severity: "safety_critical",
    slotA: "rear_rim",
    slotB: "frame",
    requiresA: ["wheel_size"],
    ...
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Hinterfelge {a.wheel_size} passt nicht zur Rahmenfreigabe {b.wheel_size_rear}.",
    howToObtain: {
      wheel_size: "Felgen-Datenblatt",
      wheel_size_rear: "Rahmen-Geometrie",
    },
    sourceUrl: "https://www.dtswiss.com/",
    reviewedBy: "AetherRide Editorial",
  ...
  {
    code: "RL-CKP-004",
    title: "Vorbau-Schaftklemmung vs. Gabelschaft",
    severity: "safety_critical",
    slotA: "stem",
    slotB: "fork",
    requiresA: ["steerer_clamp_mm"],
    requiresB: ["steerer_clamp_mm"],
    predicate: "equals",
    onPass: "COMPATIBLE",
    onFail: "INCOMPATIBLE",
    explainFailDe:
      "Vorbau-Schaftklemmung {a.steerer_clamp_mm} mm ≠ Gabelschaft {b.steerer_clamp_mm} mm.",
    howToObtain: {
      steerer_clamp_mm: "Vorbau-/Gabel-Datenblatt (üblich 28,6 mm)",
    },
