...
export const FAQ_ITEMS: {
  ...
  },
  {
    ...
    a: "Online in neun Regionen: DACH, Frankreich, Alpen-Süd, Benelux, Nord-, Mitte- und Süditalien, Katalonien/Pyrenäen, Südengland. In DACH liegen Atlas und ab Zoom 12 Wege für DE, AT, CH und LI — nicht nur in zehn Städten. Die Karte wechselt mit dem Ausschnitt. Offline sind das Stadt-Packs zum Routing in der App — keine Länderkarte. Sizilien, Sardinien, Skandinavien, Polen, der Rest von UK und Iberien sind Löcher.",
    links: [
      { href: "/karten", label: "Karten" },
