...
> = {
  "AT-7": {
    ...
    openQuestions: [
      ...
      "Verhältnis Forstgesetz zu lokalen MTB-Verträgen — Legal-Formulierung der App-Texte?",
      "Hard-Block nur bei bicycle=no vs. zusätzlicher Block bei unbestätigtem Wald — Empfehlung Counsel?",
      "Darf die App mtbOfficial-Tags als „freigegeben markiert“ anzeigen?",
    ],
  ...
  "DE-BY": {
    ...
    sources: [
      ...
      {
        id: "by-natschg",
        label: "BayNatSchG (Betretungsrecht — Abgleich durch Counsel)",
    ...
    openQuestions: [
      ...
      "Fußgängervorrang: reicht Hinweis in Mehr-Text oder Pflicht in Kurzfassung?",
    ],
    launchEligible: false,
  },
  OTHER_PENDING: {
