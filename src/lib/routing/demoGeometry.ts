...
const BASE: Record<string, { lat: number; lng: number }> = {
  ...
  "r-hamburg-alster": { lat: 53.557, lng: 10.0 },
  "r-kiel-foerde": { lat: 54.323, lng: 10.14 },
  "r-berlin-tempelhof": { lat: 52.474, lng: 13.404 },
  "r-potsdam-havel": { lat: 52.399, lng: 13.064 },
  "r-duesseldorf-rhein": { lat: 51.227, lng: 6.773 },
  "r-frankfurt-main": { lat: 50.11, lng: 8.682 },
  "r-leipzig-neuseen": { lat: 51.247, lng: 12.372 },
  "r-wien-donauinsel": { lat: 48.222, lng: 16.414 },
  "r-zuerich-see": { lat: 47.354, lng: 8.545 },
