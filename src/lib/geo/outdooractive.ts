...
const DEMO_TOURS: OutdooractiveTour[] = [
  {
    ...
    title: "Kaltenbronn Panorama (Demo)",
    type: "tour",
    difficulty: "mittel",
    lengthKm: 32,
    elevationM: 890,
    durationMin: 180,
    summary: "Demo-Enrichment ohne API-Key — echte Touren mit OUTDOORACTIVE_* Keys.",
  ...
  {
    id: "oa-demo-alpbach",
    title: "Alpbachtal Trail Mix (Demo)",
    type: "tour",
    difficulty: "schwer",
    lengthKm: 26,
    elevationM: 1100,
    durationMin: 160,
    summary: "DACH-Enrichment-Platzhalter — Routing bleibt Valhalla/OSRM.",
    url: "https://www.outdooractive.com/",
