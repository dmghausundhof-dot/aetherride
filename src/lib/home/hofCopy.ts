...
const DE: HofCopy = {
  ...
  libraryKicker: "Platz",
  libraryHint: "Deine Touren, Stimmen und Gruppen. Dieselben Touren wie auf der Karte.",
  akteMein: "Mein",
  akteStimmen: "Stimmen",
...
const EN: HofCopy = {
  ...
  shopLockedTitle: "Online store locked",
  ...
  libraryKicker: "Platz",
  libraryHint: "Your tours, Stimmen and groups. The same tours as on the map.",
  akteMein: "Mine",
  akteStimmen: "Stimmen",
...
const FR: HofCopy = {
  ...
  shopLockedTitle: "Online Store verrouillé",
  ...
  libraryKicker: "Platz",
  libraryHint: "Tes tours, Stimmen et groupes. Les mêmes tours que sur la carte.",
  akteMein: "Moi",
  akteStimmen: "Stimmen",
...
const IT: HofCopy = {
  ...
  shopLockedTitle: "Online Store bloccato",
  ...
  libraryKicker: "Platz",
  libraryHint: "I tuoi tour, Stimmen e gruppi. Gli stessi tour che sulla mappa.",
  akteMein: "Mio",
  akteStimmen: "Stimmen",
