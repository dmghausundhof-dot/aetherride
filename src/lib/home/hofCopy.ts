...
const NL: HofCopy = {
  ...
  shopForYourBikeEmpty:
    "Zet een fiets in de werkplaats — dan openen we de passende onderdelen in de winkel.",
  shopMerch: "Kleding",
  ...
  libraryMappe: "Die Mappe",
  tafelKicker: "Die Tafel",
  tafelHint: "Eén stem of één groep — geen feed.",
  ...
  workshopEmpty: "Nog geen fiets hier",
  workshopEmptyHint:
    "Naam en type volstaan. De catalogus is zoeken — serieonderdelen alleen als je ze overneemt.",
  workshopAddBasicHint: "Naam en type — iedereen kan dit",
  workshopAddCatalog: "Catalogus zoeken",
  workshopAddCatalogHint: "Model vinden, kit optioneel",
  workshopAddPlaceholder: "Plaatshouder",
  workshopAddPlaceholderHint: "Zonder onderdelen — track via Tochten",
  workshopTabBox: "Die Box",
  ...
  workshopZoneSensor: "Sensor",
  workshopMore: "Meer aan de fiets",
  workshopLoading: "Werkplaats wordt geladen…",
  workshopTabOverview: "Overzicht",
  workshopTabParts: "Componenten",
  workshopTabSetups: "Setup",
  ...
  shopPausedHint:
    "De winkel is voorlopig dicht. De werkplaats blijft — fiets, setup en onderhoud.",
  shopLockedBody:
  ...
  rideBridgeHint:
    "Live-GPS, offlinekaarten, sensoren en achtergrondopname lopen alleen native — niet in de browser.",
  ridePlannedKicker: "Geplande tocht",
  rideBackToMap: "Terug naar de kaart",
  downloadTitle: "De app onderweg",
  downloadHint:
    "Home, kaart en werkplaats lopen in de browser. Eruit met HUD — alleen in de app.",
  activitiesTitle: "Wat er binnenkwam",
  activitiesHint:
    "Ritten uit de app. Opname blijft native — hier alleen wat er echt is.",
  ...
  chatHint: "Power-user. Geen feed op Home. De werkplaats blijft de werkplaats.",
  coachBell: "Notities",
  privacyKicker: "Jij",
  privacyHint:
  ...
  careInWorkshop: (n) => String(n) + " — in de werkplaats",
