...
const RAW: TourInput[] = [
  ...
  // --- Region B: Bayern / Bodensee / weitere DACH ---
  {
    id: "r-starnberg-road",
    name: "Starnberger See Road Loop",
    primaryCategory: "road",
    categories: ["road", "etrekking", "urban"],
    distanceKm: 52,
    elevationM: 280,
    ...
    loop: true,
    regionSlug: "bayern",
    tags: ["rennrad", "see", "starnberg"],
  },
  {
    id: "r-ammersee-gravel",
    name: "Ammersee West Gravel",
    primaryCategory: "gravel",
    categories: ["gravel", "road", "emtb"],
    distanceKm: 46,
    elevationM: 520,
    ...
    loop: true,
    regionSlug: "bayern",
    tags: ["gravel", "ammersee"],
  },
  {
    id: "r-garmisch-emtb",
    name: "Garmisch E-MTB Loisach",
    primaryCategory: "emtb",
    categories: ["emtb", "mtb_am", "gravel"],
    distanceKm: 38,
    elevationM: 1100,
    durationMin: 150,
    difficulty: "S1–S2",
    ...
    loop: true,
    regionSlug: "bayern",
    tags: ["e-mtb", "garmisch", "alpen"],
  },
  {
    id: "r-lindau-road",
    name: "Lindau–Bregenz Bodensee Road",
    primaryCategory: "road",
    categories: ["road", "etrekking", "urban"],
    distanceKm: 34,
    elevationM: 120,
    ...
    loop: false,
    regionSlug: "bodensee",
    tags: ["rennrad", "bodensee", "lindau"],
  },
  {
    id: "r-friedrichshafen-urban",
    name: "Friedrichshafen Hafen–City",
    primaryCategory: "urban",
    categories: ["urban", "road", "etrekking"],
    distanceKm: 16,
    elevationM: 50,
  ...
  {
    id: "r-regensburg-urban",
    name: "Regensburg Donau–Altstadt",
    primaryCategory: "urban",
    categories: ["urban", "road", "etrekking"],
    distanceKm: 18,
    elevationM: 70,
    ...
    loop: true,
    regionSlug: "bayern",
    tags: ["city", "regensburg", "donau"],
  },
  {
    id: "r-augsburg-road",
    name: "Augsburg–Lech Road",
    primaryCategory: "road",
    categories: ["road", "etrekking"],
    distanceKm: 48,
    elevationM: 260,
    ...
    loop: true,
    regionSlug: "bayern",
    tags: ["rennrad", "augsburg"],
  },
  {
    id: "r-passau-touring",
    name: "Passau Dreiflüsse E-Trekking",
    primaryCategory: "etrekking",
    categories: ["etrekking", "road", "urban"],
    distanceKm: 42,
    elevationM: 180,
    ...
    loop: false,
    regionSlug: "bayern",
    tags: ["touring", "e-bike", "passau"],
  },
  {
    id: "r-wuerzburg-road",
    name: "Würzburg Main–Weinberge Road",
    primaryCategory: "road",
    categories: ["road", "etrekking", "gravel"],
    distanceKm: 44,
    elevationM: 380,
    ...
    loop: true,
    regionSlug: "bayern",
    tags: ["rennrad", "main", "würzburg"],
  },
  {
    id: "r-dresden-urban",
    name: "Dresden Elbe–Altstadt",
    primaryCategory: "urban",
    categories: ["urban", "road", "etrekking"],
    distanceKm: 20,
    elevationM: 90,
    ...
    loop: true,
    regionSlug: "sachsen",
    tags: ["city", "dresden", "elbe"],
  },
  // --- Rhein-Neckar Nähe (DACH densify) ---
  {
    id: "r-wiesloch-feierabend",
    ...
    loop: true,
    regionSlug: "rhein-neckar",
    tags: ["feierabend", "wiesloch", "60min"],
  },
  {
    id: "r-speyer-rhein",
    name: "Speyer Rheinauen",
    primaryCategory: "road",
    categories: ["road", "etrekking", "urban"],
    distanceKm: 28,
    elevationM: 40,
    ...
    loop: true,
    regionSlug: "rhein-neckar",
    tags: ["touring", "rhein", "speyer", "flach"],
  },
  {
    id: "r-ladenburg-neckar",
    name: "Ladenburg Neckarschleife",
    primaryCategory: "road",
    categories: ["road", "etrekking"],
    distanceKm: 26,
    elevationM: 120,
    ...
    loop: true,
    regionSlug: "rhein-neckar",
    tags: ["neckar", "ladenburg"],
  },
  {
    id: "r-bruchsal-gravel",
    name: "Bruchsal Kraichgau Gravel",
    primaryCategory: "gravel",
    categories: ["gravel", "road", "emtb"],
    distanceKm: 34,
    elevationM: 320,
    ...
    loop: true,
    regionSlug: "rhein-neckar",
    tags: ["gravel", "kraichgau", "bruchsal"],
  },
  {
    id: "r-schwetzingen-urban",
    name: "Schwetzingen Schloss–Rhein",
    primaryCategory: "urban",
    categories: ["urban", "road", "etrekking"],
    distanceKm: 18,
    elevationM: 50,
    ...
    loop: true,
    regionSlug: "rhein-neckar",
    tags: ["city", "schwetzingen"],
  },
  {
    id: "r-hockenheim-flat",
    ...
    loop: true,
    regionSlug: "rhein-neckar",
    tags: ["rennrad", "hockenheim", "flach"],
  },
  // --- Region C light: Alpen / EU-Ideen ---
  {
    id: "r-innsbruck-road",
    name: "Innsbruck Inntal Road",
    primaryCategory: "road",
    categories: ["road", "etrekking"],
    distanceKm: 48,
    elevationM: 420,
  ...
  {
    id: "r-zillertal-gravel",
    name: "Zillertal Gravel Valley",
    primaryCategory: "gravel",
    categories: ["gravel", "emtb", "road"],
    distanceKm: 55,
    elevationM: 780,
    durationMin: 180,
    difficulty: "—",
  ...
  },
  {
    ...
    loop: true,
    regionSlug: "alpen-west",
    tags: ["e-mtb", "chamonix", "alpen"],
  },
  {
    id: "r-geneve-urban",
    name: "Genève Lac–City Loop",
    primaryCategory: "urban",
    categories: ["urban", "road", "etrekking"],
    distanceKm: 22,
    elevationM: 110,
  ...
  {
    id: "r-tuebingen-neckar",
    name: "Tübingen Neckar–Österberg",
    primaryCategory: "gravel",
    categories: ["gravel", "road", "urban", "emtb"],
    distanceKm: 18,
    elevationM: 220,
    durationMin: 60,
    difficulty: "—",
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["tuebingen", "neckar", "feierabend", "60min"],
  },
  {
    id: "r-heilbronn-wartberg",
    name: "Heilbronn Neckar–Wartberg",
    primaryCategory: "road",
    categories: ["road", "gravel", "etrekking"],
    distanceKm: 22,
    elevationM: 200,
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["heilbronn", "neckar", "weinberge"],
  },
  {
    id: "r-pforzheim-enz",
    name: "Pforzheim Enztal Gravel",
    primaryCategory: "gravel",
    categories: ["gravel", "mtb_trail", "emtb"],
    distanceKm: 24,
    elevationM: 280,
    durationMin: 75,
    difficulty: "S0–S1",
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["pforzheim", "nordschwarzwald", "gravel"],
  },
  {
    id: "r-offenburg-kinzig",
    name: "Offenburg Kinzig–Ortenau",
    primaryCategory: "road",
    categories: ["road", "gravel", "etrekking"],
    distanceKm: 28,
    elevationM: 180,
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["offenburg", "ortenau", "kinzig"],
  },
  {
    id: "r-reutlingen-achalm",
    name: "Reutlingen Achalm Trail",
    primaryCategory: "mtb_trail",
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["reutlingen", "alb", "mtb"],
  },
  {
    id: "r-baden-baden-allee",
    name: "Baden-Baden Lichtental Loop",
    primaryCategory: "road",
    categories: ["road", "urban", "etrekking"],
    distanceKm: 16,
    elevationM: 200,
  ...
  },
  {
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["esslingen", "neckar", "city"],
  },
  {
    id: "r-ludwigsburg-favorite",
    name: "Ludwigsburg Favoritepark",
    primaryCategory: "urban",
    categories: ["urban", "road", "etrekking"],
    distanceKm: 14,
    elevationM: 90,
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["ludwigsburg", "park", "barock"],
  },
  {
    id: "r-titisee-feldberg",
    name: "Titisee Feldberg-Vorland MTB",
    primaryCategory: "mtb_am",
    categories: ["mtb_am", "mtb_trail", "emtb"],
    distanceKm: 22,
    elevationM: 520,
    durationMin: 90,
    difficulty: "S1–S2",
    ...
    loop: true,
    regionSlug: "schwarzwald",
    tags: ["titisee", "feldberg", "mtb", "hochschwarzwald"],
  },
  {
    id: "r-baiersbronn-murg",
    name: "Baiersbronn Murgtal MTB",
    primaryCategory: "mtb_trail",
    categories: ["mtb_trail", "mtb_am", "emtb", "gravel"],
    distanceKm: 26,
    elevationM: 560,
    ...
    loop: true,
    regionSlug: "schwarzwald",
    tags: ["baiersbronn", "murg", "nordschwarzwald"],
  },
  {
    id: "r-loerrach-dinkelberg",
    name: "Lörrach Dinkelberg Trail",
    primaryCategory: "mtb_trail",
    categories: ["mtb_trail", "gravel", "emtb"],
    distanceKm: 21,
    elevationM: 320,
    durationMin: 75,
    difficulty: "S1",
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["loerrach", "dinkelberg", "dreilaendereck"],
  },
  {
    id: "r-ravensburg-schussen",
    name: "Ravensburg Schussenauen",
    primaryCategory: "road",
    categories: ["road", "urban", "etrekking"],
    distanceKm: 20,
    elevationM: 150,
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["ravensburg", "oberschwaben", "schussen"],
  },
  {
    id: "r-villingen-baar",
    name: "Villingen Baar–Brigach",
    primaryCategory: "gravel",
    categories: ["gravel", "road", "etrekking"],
    distanceKm: 24,
    elevationM: 220,
    ...
    loop: true,
    regionSlug: "baden-wuerttemberg",
    tags: ["villingen", "baar", "brigach"],
  },
  {
    id: "r-friedrichshafen-see",
    name: "Friedrichshafen Hafen–Seewald",
    primaryCategory: "urban",
    categories: ["urban", "road", "etrekking"],
    distanceKm: 18,
    elevationM: 60,
