...
const DE: ShareCopy = {
  ...
  catalogNoTrack: "Kein Extra-Track im Link — Katalog-Tour, schon öffentlich.",
...
const EN: ShareCopy = {
  ...
  catalogNoTrack: "No extra track in the link — catalogue tour, already public.",
...
const FR: ShareCopy = {
  ...
  catalogNoTrack: "Pas de trace extra dans le lien — sortie catalogue, déjà publique.",
...
const IT: ShareCopy = {
  ...
  catalogNoTrack: "Nessuna traccia extra nel link — uscita catalogo, già pubblica.",
