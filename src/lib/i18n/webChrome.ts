...
const NL: WebChrome = {
  ...
  arriveAtHof: "Aankomen op het erf",
  signIn: "Aanmelden",
  ...
  footerTagline: "De fiets woont hier. Jij komt terug.",
  footerLegalLine: "Offline-first · AVG · Web is Home, de app rijdt.",
  aboutFlowLine: "Over FlowLine",
  faq: "FAQ",
  share: "Delen",
  sampleProfile: "Voorbeeldprofiel",
  screensFlows: "Schermen & flows",
  webVsApp: "Web vs. app",
  ...
  marketingNotFoundTitle: "Deze pagina bestaat niet",
  marketingNotFoundHint:
    "Geen feed, geen vulroute. Terug naar de website of naar Home.",
  maintenanceDue: (n) => `${n} onderhoudsbeurten vervallen`,
  newStimmenPlatz: "Nieuwe Stimmen op de Platz",
  profile: "Profiel",
  fourDoors: "Vier deuren",
  tabOf: (index, count) => `Tab ${index} van ${count}`,
  emptyStand: "Lege stand",
  discoverApp: "Ontdek de app",
  loadApp: "App downloaden",
  loadAppStore: "Download in de App Store",
  loadPlayStore: "Download bij Google Play",
  loading: "Laden…",
  anmeldenLocal: "Zonder account blijft Home lokaal bruikbaar.",
  stillToHof: "Toch naar Home",
};
