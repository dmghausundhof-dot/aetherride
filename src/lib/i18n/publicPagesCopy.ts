...
const DE: PublicPagesCopy = {
  pricing: {
    ...
    lead: "Touren auf der Karte und Planen ist für alle da. Mehrere Räder, Bracketing und ehrliche Reichweiten-Spannen sind Pro — Navigation läuft in der App auf beiden Stufen.",
    freeHint: "Touren, Planen, 1 Rad, App-Navigation",
    ...
    rows: [
      ...
      { feature: "1 Rad am Stand", free: true, pro: true },
      ...
      { feature: "Offline-Routing (Pack)", free: true, pro: true },
  ...
  download: {
    ...
    lead: "Der Hof, die Karte, die Touren und das Rad laufen im Browser. Rausfahren mit HUD, Uhr koppeln und Sensoren — nur in der nativen App.",
    noStore:
      "Noch keine Store-Links. Der Hof, die Karte, die Touren und das Rad laufen im Browser. HUD, Offline und Sensoren kommen mit der nativen App.",
    ...
    reasons: [
      ...
      {
        title: "Offline",
        body: "Offline-Routing des Packs ohne Netz. Übersicht extra. Im Browser nicht sinnvoll.",
      },
      {
        title: "Sensoren & BLE",
  ...
  serviceCheck: {
    ...
    free: "Status am Rad — immer kostenlos",
    sources: "Quellen sichtbar pro Intervall (kein „KI hat gesagt“)",
    deepLink: "Deep-Link: gleicher Status wie am Rad in der App",
    toWorkshop: "Zum Rad",
    toMaintenance: "Zum Rad · Wartung",
    ...
    demoFoot: "Demo-Darstellung — echte Werte kommen aus deinem Rad am Stand.",
...
const EN: PublicPagesCopy = {
  pricing: {
    ...
    rows: [
      ...
      { feature: "1 bike at the stand", free: true, pro: true },
  ...
  download: {
    ...
    lead: "Home, Map, Tours and the bike run in the browser. Ride out with HUD, pair a watch and sensors — only in the native app.",
    noStore:
      "No store links yet. Home, Map, Tours and the bike run in the browser. HUD, offline and sensors come with the native app.",
    ...
    reasons: [
      ...
      {
        title: "Offline",
        body: "Pack offline routing without a network. Overview is extra. Not useful in the browser.",
      },
      {
        title: "Sensors & BLE",
  ...
  serviceCheck: {
    ...
    free: "Status on the bike — always free",
    sources: "Sources visible per interval (no “the AI said so”)",
    deepLink: "Deep link: the same status as on the bike in the app",
    toWorkshop: "To the bike",
    toMaintenance: "To the bike · service",
    ...
    demoFoot: "Demo display — real values come from your bike at the stand.",
...
const FR: PublicPagesCopy = {
  pricing: {
    ...
    rows: [
      ...
      { feature: "1 vélo au stand", free: true, pro: true },
      ...
      { feature: "Routage hors ligne (pack)", free: true, pro: true },
  ...
  download: {
    ...
    lead: "Home, Carte, Parcours et le vélo tournent dans le navigateur. Sortir avec HUD, coupler la montre et les capteurs — seulement dans l’appli native.",
    noStore:
      "Pas encore de liens store. Home, Carte, Parcours et le vélo tournent dans le navigateur. HUD, hors ligne et capteurs viennent avec l’appli native.",
    ...
    reasons: [
      ...
      {
        title: "Hors ligne",
        body: "Routage hors ligne du pack sans réseau. Aperçu en extra. Pas utile dans le navigateur.",
      },
      {
  ...
  serviceCheck: {
    ...
    free: "Statut sur le vélo — toujours gratuit",
    sources: "Sources visibles par intervalle (pas de « l’IA a dit »)",
    deepLink: "Deep link : le même statut que sur le vélo dans l’appli",
    toWorkshop: "Vers le vélo",
    toMaintenance: "Vers le vélo · entretien",
    ...
    demoFoot:
      "Affichage démo — les vraies valeurs viennent de ton vélo au stand.",
...
const IT: PublicPagesCopy = {
  pricing: {
    ...
    rows: [
      ...
      { feature: "1 bici allo stand", free: true, pro: true },
      ...
      { feature: "Routing offline (pack)", free: true, pro: true },
  ...
  download: {
    ...
    lead: "Home, Mappa, Percorsi e la bici girano nel browser. Uscire con HUD, accoppiare orologio e sensori — solo nell’app nativa.",
    noStore:
      "Ancora nessun link store. Home, Mappa, Percorsi e la bici girano nel browser. HUD, offline e sensori arrivano con l’app nativa.",
    ...
    reasons: [
      ...
      {
        title: "Offline",
        body: "Routing offline del pack senza rete. Panoramica a parte. Nel browser non ha senso.",
      },
      {
        title: "Sensori e BLE",
  ...
  serviceCheck: {
    ...
    free: "Stato sulla bici — sempre gratis",
    sources: "Fonti visibili per intervallo (niente «l’IA ha detto»)",
    deepLink: "Deep link: lo stesso stato della bici nell’app",
    toWorkshop: "Verso la bici",
    toMaintenance: "Verso la bici · manutenzione",
    ...
    demoFoot:
      "Vista demo — i valori veri arrivano dalla tua bici allo stand.",
...
const NL: PublicPagesCopy = {
  pricing: {
    ...
    rows: [
      ...
      { feature: "1 fiets op de stand", free: true, pro: true },
  ...
  download: {
    ...
    lead: "Home, Kaart, Tochten en de fiets draaien in de browser. Eruit met HUD, horloge en sensoren koppelen — alleen in de native app.",
    noStore:
      "Nog geen store-links. Home, Kaart, Tochten en de fiets draaien in de browser. HUD, offline en sensoren komen met de native app.",
    ...
    reasons: [
      ...
      {
        title: "Offline",
        body: "Offline-routing van het pack zonder netwerk. Overzicht extra. In de browser niet zinvol.",
      },
      {
        title: "Sensoren & BLE",
  ...
  serviceCheck: {
    ...
    free: "Status aan de fiets — altijd gratis",
    sources: "Bronnen zichtbaar per interval (geen „de AI zei het”)",
    deepLink: "Deep link: dezelfde status als aan de fiets in de app",
    toWorkshop: "Naar de fiets",
    toMaintenance: "Naar de fiets · onderhoud",
    ...
    demoFoot:
      "Demo-weergave — echte waarden komen van jouw fiets aan de stand.",
