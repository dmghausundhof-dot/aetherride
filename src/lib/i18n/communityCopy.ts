...
const DE: CommunityCopy = {
  ...
  eventsLead: "Redaktionell. Kein erfundenes RSVP.",
  regionCta: "Region ansehen",
  clubsTitle: "Clubs light",
  clubsLead: "Orientierung — keine Live-Mitgliedschaftspflicht.",
...
const EN: CommunityCopy = {
  ...
  features: [
    ...
    {
      title: "Events & clubs",
      body: "Editorial meetups and orientation. No fake RSVP, no live-location requirement.",
  ...
  eventsLead: "Editorial. No invented RSVP.",
  regionCta: "See the region",
  clubsTitle: "Clubs light",
  clubsLead: "Orientation — no live membership requirement.",
...
const FR: CommunityCopy = {
  ...
  features: [
    ...
    },
    {
      ...
      body: "Rencontres éditoriales et orientation. Pas de faux RSVP, pas d’obligation de position live.",
      href: "/community#events",
      cta: "Dates",
    },
  ],
  ...
  eventsLead: "Éditorial. Pas de RSVP inventé.",
  regionCta: "Voir la région",
  clubsTitle: "Clubs light",
  clubsLead: "Orientation — pas d’obligation d’adhésion live.",
...
const IT: CommunityCopy = {
  ...
  features: [
    ...
    {
      title: "Eventi e club",
      body: "Incontri editoriali e orientamento. Niente RSVP finto, niente obbligo di posizione live.",
      href: "/community#events",
      cta: "Date",
    },
  ],
  ...
  eventsLead: "Editoriale. Niente RSVP inventato.",
  regionCta: "Vedi la regione",
  clubsTitle: "Club light",
  clubsLead: "Orientamento — niente obbligo di iscrizione live.",
