...
/// Cover + lower third — bike sits on the stand, sky is cropped first.
const Alignment kStandPhotoAlignment = Alignment(0, 0.44);
    ...
    return ClipRRect(
      ...
      child: SizedBox(
        ...
        child: Stack(
          ...
          children: [
            if (photo)
              const ColoredBox(color: Color(0xFF121215))
            else
              SvgPicture.asset(
                radStandGroundAsset,
                fit: BoxFit.cover,
